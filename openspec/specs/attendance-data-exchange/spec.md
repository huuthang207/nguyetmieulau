# Capability: attendance-data-exchange

## Purpose

Định nghĩa import/export JSON cho `member profile` và export JSON cho dữ liệu attendance để phục vụ quản trị và đối soát.
