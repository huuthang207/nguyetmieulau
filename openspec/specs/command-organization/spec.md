# Capability: command-organization

## Purpose

Định nghĩa cách bot tổ chức slash commands theo domain (`/help`, `/config`, `/vote`, `/member`), quyền sử dụng từng nhóm lệnh, và help output giúp user/admin khám phá command tree hiện tại.
