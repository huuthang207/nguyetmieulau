...
Định nghĩa member management panel trong kênh member chung, bao gồm cách admin post panel, menu xem/cập nhật profile, luồng chọn `mon_phai` rồi nhập `ingame_name`, và quyền sử dụng panel.
